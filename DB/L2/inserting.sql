...
VALUES	('Іноземна мова', 10, 20, 10, 4, 'test', 10),
		...
		('Проектування алгоритмів', 100, 20, 10, 3, 'test', 1),
		('Системне програмне забезпечення', 100, 20, 10, 3, 'exam', 2),
		...
		('Евристика', 100, 20, 10, 3, 'test', 10),
		('Політична наука', 10, 20, 10, 3, 'test', 10),
		('Ігрові види спорту', 100, 20, 10, 3, 'test', 6),
...
VALUES	('Олексієнко', 'Олексій', 'Олексійович'),
